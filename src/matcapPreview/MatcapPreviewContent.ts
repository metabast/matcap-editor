    ...
    public addObject(object: Object3D) {
        ...
        object.traverse((child) => {
            if (child instanceof Mesh) {
                ...
                if (originMaterial.roughness) child.material.roughness = originMaterial.roughness;

                if (originMaterial.roughnessMap) child.material.roughnessMap = originMaterial.roughnessMap;

                if (originMaterial.normalMap) child.material.normalMap = originMaterial.normalMap;
