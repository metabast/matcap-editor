...
import { AddLightCommand } from '@/legacy/commands';
import { SetLightModelPositionCommand } from '@/legacy/commands/SetLightPositionCommand';
import type { ValuesCommand } from '@/ts/types/PanesTypes';
import events, { emitSnapshot } from '@/legacy/commons/Events';
import type MatcapEditorWorld from '@/legacy/matcapEditor/MatcapEditorWorld';
import LightModel from '@/legacy/matcapEditor/LightModel';
import RenderManager from '@/legacy/matcapEditor/RenderManager';
import { matcapEditorStore } from '@/stores/matcapEditorStore';
import { LightFabric } from '@/legacy/matcapEditor/LightFabric';
