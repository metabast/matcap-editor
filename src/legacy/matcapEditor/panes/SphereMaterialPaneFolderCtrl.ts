import { SetSphereMaterialParamsCommand } from '@/legacy/commands/SetSphereMaterialParamsCommand';
import { Color } from 'three';
import type { Pane, TabPageApi } from 'tweakpane';
import type { ValuesPaneCtrl } from '@/ts/types/PanesTypes';
import PaneFolderControler from '@/legacy/commons/PaneFolderCtrl';
