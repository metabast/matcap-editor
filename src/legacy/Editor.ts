...
import { Loader } from '@/legacy/commons/Loader';
import { debounce } from '@/commons/Utils';

// État global de l'éditeur pour la compatibilité
import { History } from '@/legacy/history';
import type LightModel from '@/legacy/matcapEditor/LightModel';
import MatcapEditorWorld from '@/legacy/matcapEditor/MatcapEditorWorld';
import MatcapPreviewWorld from '@/legacy/matcapPreview/MatcapPreviewWorld';
import type { LightModelPositions } from '@/ts/types/PanesTypes';
import Project from '@/legacy/commons/Project';
